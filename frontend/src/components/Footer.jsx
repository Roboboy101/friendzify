        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center mb-6">
              ...
              <span className="text-2xl font-bold">Friendzify</span>
            </div>
            <p className="text-gray-400 mb-6 leading-relaxed max-w-md">
              Connecting students worldwide. Build meaningful friendships, share classroom experiences, 
              and create lasting academic relationships.
            </p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 Friendzify. All rights reserved. Built with ❤️ for students.
            </p>
